...
namespace Vivid
{
	...
	/*!
	 * @class Shader
	 * @brief A class for the Shader.
	 * @details Shader is a class that contains the vertex and pixel shaders. It can set uniforms and bind the shader. The shader can be created by the Create function.
	 */
	class Shader
	{
	private:
	...
	private:
		...
		struct ShaderProgramSource parseShader(const std::string& filepathVertexShader, const std::string& filepathPixelShader);
