...
void VividGUI::ImGuiThemeSetup()
{
	ImVec4* colors = ImGui::GetStyle().Colors;
	colors[ImGuiCol_Text] = ImVec4(1.00f, 1.00f, 1.00f, 1.00f);
	colors[ImGuiCol_TextDisabled] = ImVec4(0.50f, 0.50f, 0.50f, 1.00f);
	colors[ImGuiCol_WindowBg] = ImVec4(0.16f, 0.16f, 0.16f, 0.94f);
	colors[ImGuiCol_ChildBg] = ImVec4(0.16f, 0.16f, 0.16f, 0.94f);
	...
	colors[ImGuiCol_FrameBgHovered] = ImVec4(0.72f, 0.72f, 0.73f, 0.40f);
	...
	colors[ImGuiCol_CheckMark] = ImVec4(0.74f, 0.74f, 0.74f, 1.00f);
	...
	colors[ImGuiCol_ButtonHovered] = ImVec4(0.36f, 0.37f, 0.37f, 1.00f);
	...
	colors[ImGuiCol_Tab] = ImVec4(0.33f, 0.33f, 0.33f, 0.86f);
	colors[ImGuiCol_TabHovered] = ImVec4(0.48f, 0.48f, 0.48f, 1.00f);
	colors[ImGuiCol_TabActive] = ImVec4(0.64f, 0.64f, 0.64f, 1.00f);
	colors[ImGuiCol_TabUnfocused] = ImVec4(0.33f, 0.33f, 0.33f, 0.86f);
	colors[ImGuiCol_TabUnfocusedActive] = ImVec4(0.33f, 0.33f, 0.33f, 0.86f);
	...
	colors[ImGuiCol_TextSelectedBg] = ImVec4(0.68f, 0.68f, 0.68f, 0.35f);
	colors[ImGuiCol_DragDropTarget] = ImVec4(1.00f, 1.00f, 0.00f, 0.90f);
	colors[ImGuiCol_NavHighlight] = ImVec4(0.69f, 0.69f, 0.69f, 1.00f);
